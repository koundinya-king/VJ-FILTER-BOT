            ...
            try:
                ...
                if btn:
                    ...
                    await message.reply_photo(
                        ...
                        caption=f"👋 Hello {message.from_user.mention},\n\nPlease join the channel then click on the unmute me button. 😇",
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    # don't change anything without contacting me @kingvj01
        ...
        buttons = [[
            InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ', url="https://t.me/https://t.me/+Y9aDbpFtZ70zOGFl"),
            InlineKeyboardButton('Sᴏᴜʀᴄᴇ Cᴏᴅᴇ', url="https://t.me/SSK_MOVIES")
        ],[
